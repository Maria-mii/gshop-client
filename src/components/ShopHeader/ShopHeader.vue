<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" @click="toggleActivityShow" v-if="info.supports">
    ...
    <transition name="fade">
      <div class="activity-sheet"  v-show="activityShow">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close" @click="toggleActivityShow">
...
export default {
  data () {
    return {
      ...
      shopShow: false, // 店铺信息初始值
      activityShow: false // 活动信息初始值
    }
  },
  computed: {
    ...mapState(['info'])
